...
export class Purchases extends AwesomeCordovaNativePlugin {
  ...
  /**
   * Returns an observable that can be used to receive updates on the customer info
   *
   ...
   * @property {CustomerInfo} customerInfo - The new CustomerInfo after the successful purchase
   */
   ...
   *
   * @returns {Promise<CustomerInfo>} new customer info after resetting.
   */
  @Cordova()
   ...
   * is an error retrieving the customer info.
   */
  @Cordova()
  ...
  @Cordova()
  setupShouldPurchasePromoProductCallback(): void {}

  @Cordova()
  getMakeDeferredPurchaseFunction(callbackID: number) {}
}
